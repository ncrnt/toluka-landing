    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="adminweb.php?module=fasilitas">Profile</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-body">
                <h3 class="box-title m-b-0">Form Tambah Profile</h3>
                <p class="text-muted m-b-30 font-13"> Digunakan untuk menambahkan data </p>
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form action="module/profil/aksi_tambah.php" method="POST" enctype="multipart/form-data">                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nama</label>
                                <input type="text" name="nama" class="form-control" id="exampleInputEmail1" placeholder="Masukkan nama profile" >
                            </div>
                            <div class="form-group">
